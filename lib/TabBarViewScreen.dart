...
class TabBarViewScreen extends ScreenWidget {
  @override
  State createState() => _StateTabBarViewScreen();

  @override
  String get title => 'Tab Bar View';
}
...
class _StateTabBarViewScreen extends State<TabBarViewScreen> with SingleTickerProviderStateMixin {
